	...
	},
	{
		...
		children: [
			/* user */
			{
				...
				loadChildren: () => import('./pages/user/testpage/testpage.module').then(m => m.TestpageModule)
			}, 
			{
				path: 'testmodule',
				canActivate: [MetaGuard],
				...
				loadChildren: () => import('./modules/testmodule/pages/testmodule/testmodule.module').then(m => m.TestmoduleModule)
			}, 
			{
				path: 'profile',
				canActivate: [MetaGuard],
